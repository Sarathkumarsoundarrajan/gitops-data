    ...
    pipeline {
      ...
      """
        ...
        stages {
            ...
            stage('Validate Build Context') {
                steps {
                    script {
                        ...
                        mkdir -p ${WORKSPACE}/custom-themes
                        echo "Build context validated. Dummy directories created if missing."
                        '''
                    }
                }
            }
            ...
            stage('Install and Configure WordPress') {
                steps {
                    module_wordpress_installAndBuild()
                }
            }
